...
* Every well-defined distribution has a **mean** and a **variance**.
...
$$E(\bar{y}) = E[\frac{1}{n}\sum_{i=1}^n y_i] = \frac{1}{n}\sum_{i=1}^n E[y_i] = \frac{1}{n} n \mu_Y$$

--

* So that's good news. The expected value is equal to the population mean. 

* This means that $\bar{y}$ is an ***unbiased estimator*** for $E(y)$.
