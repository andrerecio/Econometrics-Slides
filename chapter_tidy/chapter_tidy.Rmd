---
title: "Econometrics"
subtitle: "Tidying 🧹, Visualising 📈 and </br>  Summarising 📊 Data"
...
* In order to **summarize** properly, we need to step back and remind ourselves of what ***Probability*** and ***Distributions*** are.

--

* (All of this will of course be recap from your stats classes. 🧐)
...
# Enough `tidy`ing! On to Probability!
