...
⚠️ not all students benefited equally from the treatment!
...
# fwrite(toy_data, here::here("../Econometrics/introduction/pierre_gustave/toy_data_2.csv"))
# fwrite(toy_data_random, here::here("../Econometrics/introduction/pierre_gustave/toy_data_random.csv"))
```
