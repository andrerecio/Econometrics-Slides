...
2. Instrumental variables and two-stage least squares: If we could find something that **only** affects $x_1$ but *not* the omitted variable, we can make progress!
...
## Linkup with Earlier Material

This is related to the chapters on:
...
scale_y_continuous(breaks = lm0$coefficients[2], labels = "beta1") +
