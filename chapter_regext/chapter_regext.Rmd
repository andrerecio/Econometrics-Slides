...
4. Run 3 regression models: `wage ~ educ, log(wage) ~ educ, log(wage) ~ log(educ)`. Take care with the last model! Interpret the coefficients!
...
$$y_i =  b_0 + b_1 x_{1,i} + b_2 x_{2,i} + b_3(x_{1,i} \times x_{2,i}) + ... + e_i$$
...
# Task 4: Standardized regression
