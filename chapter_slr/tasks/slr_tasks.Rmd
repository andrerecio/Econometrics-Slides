...
# Task 6: Standardized Regression
...
**Notice:** The *range* of data is no longer the same: standardized `r paste0("[",paste(range(cars$dist_std),collapse = ","),"]")` and not `r paste0("[",paste(range(cars$dist),collapse = ","),"]")` . We *rescaled* the variables by a a number (that's what the division did). That's why our slope estimate is not the same anymore.
