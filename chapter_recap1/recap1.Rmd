...
scale_x_continuous(breaks = 0, labels = "beta") +
theme_simple +
...
We will discuss solutions to **violations of these assumptions**. See also our discussion [in the book](https://scpoecon.github.io/Econometrics/std-errors.html#class-reg)
